...
public class FrostomperModel extends HierarchicalModel<FrostomperEntity>
{
	...
	public void setupAnim(FrostomperEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
		...
		entity.idleAnimationState.animateIdle(this, FrostomperAnimation.idle, ageInTicks, limbSwingAmount, entity.animationEntries.walkEntries);
		...
		entity.walkAnimationState.animateWalk(this, FrostomperAnimation.walk, limbSwing, limbSwingAmount, 2.5F, 2.5F, entity.animationEntries.extraEntries);
	}
