...
import net.sammmmy1628.blastfromthepast.client.animation.BabySnowdoAnimation;
...
public class BabySnowdoModel<T extends SnowdoEntity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(BlastFromThePast.MOD_ID, "baby_snowdo"), "main");
